...
// Connect to DB
mongoose.connect('mongodb+srv://hrithik:hrithik123@users-6oe1e.gcp.mongodb.net/test?retryWrites=true'); //Will be different for the localhost and the different user.
